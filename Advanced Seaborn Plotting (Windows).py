...
# NOTE: This file is formatted for Windows (i.e. it has both CR and LF at the end of each line).
# There is a file that is formatted for Linux (i.e. just the LF) at:
# https://github.com/SynchronicAnalytics/python-advanced-plotting-with-seaborn/Advanced Searborn Plotting (Linux).py
